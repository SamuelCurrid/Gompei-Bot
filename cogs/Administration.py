...
class Administration(commands.Cog):
    ...
    async def on_member_update(self, before, after):
        ...
        if after in Config.guilds[after.guild]["administration"]["jails"]:
            ...
            if len(added_roles) > 0:
                ...
                jail_embed.set_author(name=after.name + "#" + after.discriminator, icon_url=after.display_avatar.url)
    ...
    async def avatar(self, ctx, user: typing.Union[discord.Member, discord.User, str]):
        ...
        embed.set_author(name=user.name + "#" + user.discriminator, icon_url=user.display_display_avatar.url)
        embed.set_image(url=user.display_display_avatar.url)
    ...
    async def mute(self, ctx, member: discord.Member, time, *, reason):
        ...
        mute_embed.set_author(name=member.name + "#" + member.discriminator, icon_url=member.display_avatar.url)
    ...
    async def jail(self, ctx, member: discord.Member, time: str, *, reason: str):
        ...
        jail_embed.set_author(name=member.name + "#" + member.discriminator, icon_url=member.display_avatar.url)
